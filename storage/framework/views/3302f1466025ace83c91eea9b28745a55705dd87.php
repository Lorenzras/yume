...
<div style="padding-bottom: calc(5.125rem / 2); position: relative; margin-bottom: 1.5rem;">
  <div class="bg-primary" style="min-height: 150px;">
    <div class="d-flex align-items-end <?php echo e($containerClass ?? 'container'); ?> page__container" style="position: absolute; left: 0; right: 0; bottom: 0;">
      <div class="avatar avatar-xl">
        <img src="<?php echo e(asset('/vendor/flowdash/images/avatar/demi.png')); ?>" alt="avatar" class="avatar-img rounded" style="border: 2px solid white;">
      </div>
...
$activity = [[
  ...
  'card' => [
    'image' => "/vendor/flowdash/images/choose/demo1.png",
...
<?php echo $__env->make("flowdash::layouts.{$layout}", [
  'title' => 'Profile',
  'user_header' => false
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/profile.blade.php ENDPATH**/ ?>