      ...
      <div class="card">
        <ul class="list-group list-lessons">
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">1. Wireframe</a>
          ...
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">2. Design with Sketch</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">3. Build static HTML/CSS with Bootstrap 4</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">4. Rails New Application</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">5. Github and push your first commit.</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">6. Add Bootstrap 4 to Rails</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">7. Include Designed SASS assets</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">8. Basics of Routing</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">9. Postgres Database</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">10. Setup Authentification with Devise</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">11. Design &amp; Code the User Account</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">12. Scaffold a Discussions Feature with Rails</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">13. Refactoring and Refining</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">14. Validations</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">15. Rails Testing</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">16. Create Staging and Production Servers</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
          <li class="list-group-item d-flex">
            <a href="<?php echo e(route('app-lesson')); ?>">17. Deploy your Rails App with Capistrano</a>
            <div class="ml-auto">
              <span class="text-muted"><i class="material-icons icon-16pt icon-light">watch_later</i> 1:42</span>
            </div>
          </li>
...
<?php echo $__env->make("flowdash::layouts.{$layout}", [
  'title' => 'Course',
  'user_header' => false
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/app-course.blade.php ENDPATH**/ ?>