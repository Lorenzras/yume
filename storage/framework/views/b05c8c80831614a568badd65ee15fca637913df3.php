      ...
      <div class="card card__course">
        <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">          
          <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="#" >
            <span><img src="<?php echo e($item['logo']); ?>" class="mb-1" style="width:34px;" alt="logo"></span>
            <span class="course__title"><?php echo e($item['title']); ?></span>
            <span class="course__subtitle"><?php echo e($item['subtitle']); ?></span>
          </a>
        </div>
        <div class="p-3">
          <div class="mb-2"> 
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/app-browse-courses.blade.php ENDPATH**/ ?>