          ...
          <div class="card-body py-0">
            <div class="list-group list-group-small list-group-flush">
              ...
              <div class="list-group-item d-flex align-items-center px-0">
                <div class="mr-3 flex"> <i class="material-icons icon-18pt icon-muted">contacts</i> <?php echo e($chat[$i]['name']); ?></div>
                <div class="mr-3 text-dark-gray"><?php echo e($chat[$i]['date']); ?></div>
                <div><a href="">&dollar;<?php echo e(123 * $i); ?></a></div>
              </div>
...
<!-- Chart.js Samples -->
<script src="<?php echo e(mix('js/page.ecommerce.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/ecommerce.blade.php ENDPATH**/ ?>