...
<div class="<?php echo e($containerClass ?? 'container'); ?> page__container">
  ...
  <div class="card card-body px-3 d-flex flex-row align-items-center" role="alert">
    ...
    <a href="" class="ml-3"><i class="material-icons">arrow_forward</i></a>
  </div>
    ...
    <div class="col-xl-3 col-md-6 card-group-row__col">
      <div class="card card-group-row__card card-body flex-row align-items-center">
        <div class="position-relative mr-2">
          ...
          <canvas width="90" height="90" class="position-relative z-1" data-toggle="progress-chart" data-progress-chart-value="68" data-progress-chart-color="success" data-progress-chart-tone="400"></canvas>
        </div>
  ...
  <div class="card">
    ...
    <?php $__env->startComponent('flowdash::components.staff-table', [
      'items' => [[
        'name' => 'Michael Smith',
        'selected' => true,
        'avatar' => [
    ...
    ]); ?> <?php if (isset($__componentOriginal3cc4cb426cebdb8891318366b3b9f12f674c1cf4)): ?>
<?php $component = $__componentOriginal3cc4cb426cebdb8891318366b3b9f12f674c1cf4; ?>
<?php unset($__componentOriginal3cc4cb426cebdb8891318366b3b9f12f674c1cf4); ?>
<?php endif; ?>
...
<!-- Vector Maps -->
<link type="text/css" href="<?php echo e(mix('vendor/jqvmap/jqvmap.min.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
...
<!-- Chart.js Samples -->
<script src="<?php echo e(mix('js/page.analytics.js')); ?>" defer></script>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/analytics.blade.php ENDPATH**/ ?>