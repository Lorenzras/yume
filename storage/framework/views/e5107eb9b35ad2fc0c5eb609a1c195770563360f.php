<div class="navbar navbar-expand-sm navbar-main <?php echo e(config("flowdash.navbarClass.{$layout}")); ?> <?php echo e($navbarClass ?? ''); ?> pr-0" id="navbar" data-primary>
  <div class="<?php echo e($navbarContainerClass ?? ($containerClass ?? 'container')); ?> <?php echo e($layout !== 'fixed' ? 'p-0' : ''); ?>">
    ...
    <!-- Navbar Brand -->
    <a href="<?php echo e(route('home')); ?>" class="navbar-brand <?php echo e($navbarBrandClass ?? ''); ?>">
      <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="width:20px;" viewBox="0 0 40 40">
        ...
        <?php if($navbarBrandText ?? true !== false): ?>
            <span><?php echo e(config('flowdash.brand')); ?></span>
        <?php endif; ?>
    </a>
    ...
    <?php if($navbarSearch ?? true !== false): ?>
    <form class="search-form d-none d-sm-flex flex" action="<?php echo e(route('home')); ?>">
              ...
              <div class="dropdown-item d-flex">
                <div class="mr-3">
                  <div class="avatar avatar-sm" style="width: 32px; height: 32px;">
                    <img src="<?php echo e(asset('/vendor/flowdash/images/256_daniel-gaffey-1060698-unsplash.jpg')); ?>" alt="Avatar" class="avatar-img rounded-circle">
                  </div>
                </div>
                <div class="flex">
    ...
    <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
        ...
        <li class="nav-item dropdown">
            <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
              ...
              <img src="<?php echo e(asset('/vendor/flowdash/images/avatar/demi.png')); ?>" class="rounded-circle" width="32" alt="Frontted">
            </a>
            <div id="account_menu" class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item <?php echo e(activeClass('profile')); ?>" href="<?php echo e(url('/profile')); ?>">
...
</div><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/partials/navbar.blade.php ENDPATH**/ ?>