...
<div style="background:#000;">
  <div class="container w-75">
    <div class="embed-responsive embed-responsive-16by9">
      <iframe src="https://player.vimeo.com/video/95143876?color=ff9933&title=0&byline=0&portrait=0" class="embed-responsive-item"></iframe>
...
<div class="<?php echo e($containerClass ?? 'container'); ?> page__heading-container">
  <div class="page__heading d-flex align-items-center">
    ...
    <div>
      <a href="" class="btn btn-outline-success">Mark as complete <i class="material-icons ml-2">check</i></a>
        <a href="" class="btn btn-light ml-3"><i class="material-icons">chevron_left</i> Prev</a>
        <a href="" class="btn btn-light">Next <i class="material-icons">chevron_right</i></a>
    </div>
  </div>
</div>
    ...
    <div class="col-md-8">
      ...
      <div class="card py-2 px-3 my-4">
        <div class=" d-flex justify-content-between align-items-center">
          <a href="<?php echo e(route('profile')); ?>" class="flex d-flex align-items-center text-body text-underline-0">
      ...
      <div class="input-group input-group-merge mb-4">
        <textarea class="form-control form-control-appended" required="" placeholder="Type message" rows="4" style="resize: none"></textarea>
      ...
      <div class="py-3 border-bottom">
        <div class="d-flex mb-1">
          <div class="avatar avatar-sm mr-3">
            <img src="<?php echo e(asset($item['avatar'])); ?>" alt="Avatar" class="avatar-img rounded-circle">
          </div>
          <div class="flex">
            <div class="d-flex align-items-center mb-1">
              <strong class="text-15pt"><?php echo e($item['name']); ?></strong>
              <small class="ml-2 text-muted"><?php echo e($item['date']); ?></small>
            </div>
            <div>
              <?php echo $item['content']; ?>

            </div>
            <?php if(isset($item['card'])): ?>
            <a href="" class="card my-3 text-body decoration-0">
              <img src="<?php echo e(asset($item['card']['image'])); ?>" alt="image" class="rounded card-img-top">
              <span class="card-footer d-flex flex-column">
                <strong><?php echo e($item['card']['title']); ?></strong>
                <span><?php echo e($item['card']['description']); ?></span>
                <span class="text-muted"><?php echo e($item['card']['link']); ?></span>
              </span>
            </a>
            <?php endif; ?>
            <div class="d-flex align-items-center">
              <a href="" class="text-muted d-flex align-items-center decoration-0"><i class="material-icons mr-1" style="font-size: inherit;">favorite_border</i> <?php echo e($item['favorites']); ?></a>
              <a href="" class="text-muted d-flex align-items-center decoration-0 ml-3"><i class="material-icons mr-1" style="font-size: inherit;">thumb_up</i> <?php echo e($item['likes']); ?></a>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make("flowdash::layouts.{$layout}", [
  'title' => 'Lesson',
  'user_header' => false
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/app-lesson.blade.php ENDPATH**/ ?>