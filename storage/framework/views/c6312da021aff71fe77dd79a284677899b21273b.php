...
<!-- Chart.js -->
<script src="<?php echo e(mix('vendor/Chart.min.js')); ?>"></script>
<script src="<?php echo e(mix('js/chartjs-rounded-bar.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/charts.js')); ?>" defer></script>

<!-- Chart.js Samples -->
<script src="<?php echo e(mix('js/page.staff.js')); ?>" defer></script>

<!-- List.js -->
<script src="<?php echo e(mix('vendor/list.min.js')); ?>"></script>
<script src="<?php echo e(mix('js/list.js')); ?>" defer></script>

<!-- Tables -->
<script src="<?php echo e(mix('js/toggle-check-all.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/check-selected-row.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/staff.blade.php ENDPATH**/ ?>