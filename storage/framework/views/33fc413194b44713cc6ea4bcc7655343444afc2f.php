...
<!-- FullCalendar -->
<link type="text/css" href="<?php echo e(mix('vendor/fullcalendar/fullcalendar.min.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(mix('vendor/jquery-ui.min.js')); ?>" defer></script>

<!-- Moment.js -->
<script src="<?php echo e(mix('vendor/moment.min.js')); ?>" defer></script>

<!-- FullCalendar -->
<script src="<?php echo e(mix('vendor/fullcalendar/fullcalendar.min.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/fullcalendar.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/app-fullcalendar.blade.php ENDPATH**/ ?>