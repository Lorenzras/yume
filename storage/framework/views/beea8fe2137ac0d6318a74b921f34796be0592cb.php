...
<div class="<?php echo e($containerClass ?? 'container'); ?> page__container">
      ...
      <div class="card">
        ...
        <div class="card-body py-4">
          ...
          <div class="d-flex justify-content-between pb-1">
            <span><?php echo e($sale['month']); ?></span>
            <div>
              <strong>$<?php echo e($sale['min']); ?></strong> <span class="text-muted">/ $<?php echo e($sale['max']); ?></span>
            </div>
          </div>
          <div class="progress <?php echo e($loop->last ? '' : 'mb-3'); ?>" style="height: 8px;">
            <div class="progress-bar bg-<?php echo e($sale['progress_color']); ?>" role="progressbar" style="width: <?php echo e($sale['progress']); ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
  ...
  <div class="row">
    <div class="col-lg-7">
      ...
      $tasks = [[
        ...
        'color' => 'info',
        'date' => '20 Jul',
        'user_image' => '/vendor/flowdash/images/256_rsz_1andy-lee-642320-unsplash.jpg'
      ], [
        'description' => 'Fix dropdowns in navbars',
        'type' => 'Bug',
        'color' => 'danger',
        'date' => '8 Oct',
        'user_image' => '/vendor/flowdash/images/256_michael-dam-258165-unsplash.jpg'
      ], [
        'description' => 'Add new sidebar to the right',
        'type' => 'Request',
        'color' => 'info',
        'date' => '11 Oct',
        'user_image' => '/vendor/flowdash/images/256_luke-porter-261779-unsplash.jpg'
      ], [
        'description' => 'Create Dashboard for administrative tasks',
        'type' => 'feature',
        'color' => 'primary',
        'date' => '20 Oct',
        'user_image' => '/vendor/flowdash/images/avatar/demi.png'
      ]];
      ?>
          ...
          <li class="list-group-item list-group-item-action py-2">
            <div class="row align-items-center">
              ...
              <div class="col-lg d-flex align-items-center text-md-right">
                <span class="ml-auto badge badge-outline-<?php echo e($task['color']); ?>"><?php echo e($task['type']); ?></span>
                <span class="ml-2"><?php echo e($task['date']); ?></span>
                <span class="avatar avatar-xs ml-2">
                  <img src="<?php echo e($task['user_image']); ?>" class="avatar-img rounded-circle" alt="">
                </span>
              </div>
            </div>
          </li>
  ...
  $posts = [[
    ...
    'image' => '/vendor/flowdash/images/posts/fabian-irsara-92113.jpg'
  ], [
    'title' => 'DevOps Basics',
    'author' => 'Kevin Short',
    'time' => '15 hrs',
    'content' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit...',
    'image' => '/vendor/flowdash/images/posts/luke-chesser-2347.jpg'
  ], [
    'title' => 'New VueJS Launch',
    'author' => 'Andrew Robles',
    'time' => '22 hrs',
    'content' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit...',
    'image' => '/vendor/flowdash/images/posts/thought-catalog-214785.jpg'
  ], [
      ...
      <div class="row">
        ...
        <div class="col-lg-6 py-2">
          <div class="d-flex flex-column flex-xl-row align-items-center text-center text-xl-left align-items-xl-start">
            <a href=""><img class="img-fluid img-lg-150 img-xl-200 rounded mr-xl-3 mb-3 mb-xl-0" src="<?php echo e($post['image']); ?>" alt="Blog post image"></a>
            <div class="flex">
              <h5 class="card-title mb-1"><a href="" class="headings-color"><?php echo e($post['title']); ?></a></h5>
              <p class="text-muted mb-2">
                <small class="mr-1"><a href="" class="text-muted"><?php echo e($post['author']); ?></a></small>
                <small><?php echo e($post['time']); ?> ago</small>
              </p>
  ...
  <div class="card-deck card-margin">
    <div class="card">
      <img src="/vendor/flowdash/images/posts/thought-catalog-214785.jpg" class="card-img-top" alt="">
      <div class="card-body">
        <div class="d-flex align-items-center mb-3">
          <div class="avatar avatar-sm mr-3">
            <img src="/vendor/flowdash/images/avatars/andrew-robles-300868.jpg" class="avatar-img rounded-circle" alt="">
          </div>
    ...
    <div class="card dashboard-chat">
      ...
      <div class="d-flex dashboard-chat__head">
        <div class="avatar avatar-sm mr-3">
          <img src="/vendor/flowdash/images/avatars/lucas-sankey-378674.jpg" class="avatar-img rounded-circle" alt="">
        </div>
        <div class="flex">
      ...
      <div class="card-body d-flex flex-column">
        ...
        <div class="media align-items-center mb-3">
          <img src="/vendor/flowdash/images/avatars/lucas-sankey-378674.jpg" class="img-fluid rounded-circle mr-2" width="35" alt="">
...
<!-- Moment.js -->
<script src="<?php echo e(mix('vendor/moment.min.js')); ?>" defer></script>
<script src="<?php echo e(mix('vendor/moment-range.js')); ?>" defer></script>

<!-- Chart.js -->
<script src="<?php echo e(mix('vendor/Chart.min.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/charts.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/chartjs-rounded-bar.js')); ?>" defer></script>

<!-- Chart.js Samples -->
<script src="<?php echo e(mix('js/page.dashboard.js')); ?>" defer></script>
<script src="<?php echo e(mix('js/progress-charts.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\yume\resources\views/vendor/flowdash/home.blade.php ENDPATH**/ ?>